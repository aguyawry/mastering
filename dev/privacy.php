    ...
    <div class="container">
        <div class="col-group">
            ...
            <div class="col-mb-12">
                ...
                <p>This privacy notice discloses the privacy practices for elsonmastering.com. I am focused on leading my business as per these standards with a specific end goal to guarantee that the privacy of individual data is secure and maintained. This privacy notice applies solely to information collected by this website. It will notify you of the following:</p>
                ...
                <h3>Security</h3>
                <p>I take precautions to protect your information. When you submit sensitive information via the website, your information is protected both online and offline.</p>

                <p>Wherever I collect sensitive information, that information is encrypted and transmitted to me in a secure way. You can verify this by looking for a lock icon in the address bar and looking for "https" at the beginning of the address of the Web page.</p>

                <p>While I use encryption to protect sensitive information transmitted online, I also protect your information offline. Only employees who need the information to perform a specific job (for example, billing or customer service) are granted access to personally identifiable information. The computers / servers in which I store personally identifiable information are kept in a secure environment.</p>

                <p>If you feel that I am not abiding by this privacy policy, you should contact me immediately via telephone or via email.</p>
