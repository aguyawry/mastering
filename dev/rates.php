    ...
    <div class="container">
        ...
        <div class="col-group">
            <div class="col-mb-12 col-4">
                <h4><a href="#mastering">mastering</a></h4>
                <ul class="list-bullet">
                    <li><a href="#mastering-unattended">Unattended Mastering</a></li>
                    <li><a href="#mastering-attended">Attended Mastering</a></li>
                    <li><a href="#mastering-vinyl">Mastering for Vinyl Details</a></li>
                </ul>
            </div>
...
<section id="top" class="light">
    <div class="container">
        ...
        <div class="col-group">
            <div class="col-mb-12">
                <h4 id="mastering-unattended">Unattended Mastering</h4>
            </div>
        ...
        <div class="col-group">
            <div class="col-mb-12">
                <h4 id="mastering-attended">Attended Mastering</h4>
            </div>
    ...
    <div class="container">
        ...
        <div class="col-group">
            ...
            <div class="col-mb-12 col-6">
                ...
                <p>I <strong><em>do not</em></strong> recommend using this format for making Compact Discs, but in some cases it may be necessary.</p>
                ...
                <p>The PreMaster is quality controlled by both listening to it and running a check on the physical layer of the disc. Once that's done, it shouldn't be played or handled to prevent any scratching, fingerprints or other damage.</p>

                <p>I can also create CD References which are burned on the same quality media, but are not quality controlled. Clients can burn CD References themselves using my software CD image player. These should only be used for listening and not as production masters.</p>

                <p>Making a PMCD is a little more expensive due to the extra time taken for quality control and shipping. A DDPi is highly recommended instead.</p>
            </div>
            ...
            <div class="col-mb-12 col-5 col-offset-1">
                ...
                <ul class="list-bullet">
                    ...
                    <li>Creation of a track list with detailed timing information for the replicator</li>
                    <li>Upload of a software CD image player with CD Reference burning capability for client review</li>
                    <li>Quality control of the final PMCD before delivery to the replicator ensuring no unwanted sonic artifacts</li>
                </ul>
            </div>
        </div>
